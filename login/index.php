...
$errormsg = '';
$errorcode = 0;
$adminurl = new moodle_url("/local/dashboard/dashboard.php");
...
//custom login condition//////////
        ...
        $aid= $DB->get_record_sql("SELECT userid FROM {admin_registration} WHERE userid= '$testsession'");
        ...
        if(!empty($aid) && $aid->userid==$testsession)
        {            
