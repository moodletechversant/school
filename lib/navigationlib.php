...
class global_navigation extends navigation_node {
    ...
    public function __construct(moodle_page $page) {
        ...
        if ($homepage == HOMEPAGE_SITE) {
            ...
            // echo $usr;
            // exit();
            if(!empty($sid) && $sid->user_id==$usr){
                    // We are using the users my moodle for the root element.
                    $properties = array(
                        'key' => 'myhome',
                        'type' => navigation_node::TYPE_SYSTEM,
                        'text' => get_string('myhome'),
                        'action' => new moodle_url('/local/dashboard/dashboard.php?id='.$sid->user_id),
                        'icon' => new pix_icon('i/dashboard', '')
                    );
                }
               else if(!empty($tid) && $tid->user_id==$usr){
                    // We are using the users my moodle for the root element.
                    $properties = array(
                        'key' => 'myhome',
                        'type' => navigation_node::TYPE_SYSTEM,
        ...
        // else   if(!empty($sid) && $sid->user_id==$testsession){
        //     // We are using the users my moodle for the root element.
        //     $properties = array(
        //         'key' => 'myhome',
        //         'type' => navigation_node::TYPE_SYSTEM,
        ...
        //     );
        // }
        // else  if(!empty($tid) && $tid->user_id==$testsession){
        //     // We are using the users my moodle for the root element.
        //     $properties = array(
        //         'key' => 'myhome',
        //         'type' => navigation_node::TYPE_SYSTEM,
