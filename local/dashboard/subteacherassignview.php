...
$template = file_get_contents($CFG->dirroot . '/local/dashboard/templates/subteacherassignview.mustache');
...
$PAGE->navbar->add('Upcoming Assignment', new moodle_url($CFG->wwwroot.'local/dashboard/view_upcomming_assignment.php'));
