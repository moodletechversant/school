...
class reply_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('html', '<h2 class="text-center heading mb-5">Reply</h2>');
       ...
       $mform->addElement('textarea', 'creplay','Reply message','wrap="virtual" rows="6" cols="5"');
       $mform->addRule('creply', 'reply description missing', 'required', null);
