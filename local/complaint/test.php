    ...
    if (!empty($models)) {
          ...
          <table class="table mb-0">
            <thead>
              <tr>
                ...
                <th scope="col">
                  <div class="wrap-t">Complaint</div>
                </th>
                <th scope="col">
        ...
        foreach ($models as $model) {
            ...
            <tr>
                ...
                <td><div class="wrap-t"><a href="/school/local/reply/reply.php?id='.$id.'" class="action-table" ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                        <path
