    ...
    if (!empty($models)) {
        ...
        foreach ($models as $model) {
            ...
            <tr>
                ...
                <td><div class="wrap-t"><a href="/school/local/createstudent/editstudent.php?id='.$id.'" class="action-table" ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                        <path
