    ...
    <table class="table mb-0">
      ...
      foreach ($leave as $value) {
        ...
        if ($current_time >= $tdate) {
          ...
          $edit='<a href="/school/local/leaverequest/editleave.php?id='.$id.'" >
      ...
      $tick='<img class="click_ok fa fa-check" src="/school/local/img/tick.svg" width="20px" />';
      $untick='<img class="click_not fa fa-close" src="/school/local/img/untick.svg" width="20px" />';
